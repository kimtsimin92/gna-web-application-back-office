...
@Component({
  selector: 'app-simulation-radio',
  standalone: true,
  imports: [],
  templateUrl: './simulation-radio.component.html',
  styleUrl: './simulation-radio.component.css'
})
export class SimulationRadioComponent implements OnInit, AfterViewInit, OnDestroy {
