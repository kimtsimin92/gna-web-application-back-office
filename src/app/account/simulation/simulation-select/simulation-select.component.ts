...
@Component({
  selector: 'app-simulation-select',
  standalone: true,
  imports: [],
  templateUrl: './simulation-select.component.html',
  styleUrl: './simulation-select.component.css'
})
export class SimulationSelectComponent implements OnInit, AfterViewInit, OnDestroy {
