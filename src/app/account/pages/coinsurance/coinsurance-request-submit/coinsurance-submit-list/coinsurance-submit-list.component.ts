...
@Component({
  selector: 'app-coinsurance-submit-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './coinsurance-submit-list.component.html',
  styleUrl: './coinsurance-submit-list.component.css'
})
export class CoinsuranceSubmitListComponent implements OnInit, AfterViewInit, OnDestroy  {
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/coinsurance/requests/submits/view")
      .then(() => {
        this.loadingPage = false;
      });
