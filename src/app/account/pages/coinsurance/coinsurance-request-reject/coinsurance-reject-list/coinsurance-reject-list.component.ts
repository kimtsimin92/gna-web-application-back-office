...
@Component({
  selector: 'app-coinsurance-reject-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './coinsurance-reject-list.component.html',
  styleUrl: './coinsurance-reject-list.component.css'
})
export class CoinsuranceRejectListComponent implements OnInit, AfterViewInit, OnDestroy  {
