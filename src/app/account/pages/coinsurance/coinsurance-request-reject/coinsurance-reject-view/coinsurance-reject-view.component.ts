...
@Component({
  selector: 'app-coinsurance-reject-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './coinsurance-reject-view.component.html',
  styleUrl: './coinsurance-reject-view.component.css',
})
export class CoinsuranceRejectViewComponent  implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    if (localStorage.getItem('CUSTOMER_ACCOUNT_REQUEST_DATA')) {
      ...
      this._router.navigateByUrl('/account/coinsurance/requests/rejects/list');
    }
  }
