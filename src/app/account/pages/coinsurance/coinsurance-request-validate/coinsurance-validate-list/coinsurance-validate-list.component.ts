...
@Component({
  selector: 'app-coinsurance-validate-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './coinsurance-validate-list.component.html',
  styleUrl: './coinsurance-validate-list.component.css'
})
export class CoinsuranceValidateListComponent  implements OnInit, AfterViewInit, OnDestroy{
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/coinsurance/requests/validates/view")
      .then(() => {
        this.loadingPage = false;
      });
