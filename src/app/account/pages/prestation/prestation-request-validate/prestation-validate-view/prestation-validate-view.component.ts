...
@Component({
  selector: 'app-prestation-validate-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './prestation-validate-view.component.html',
  styleUrl: './prestation-validate-view.component.css'
})
export class PrestationValidateViewComponent  implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/prestation/requests/validates/list");
    }
