...
@Component({
  selector: 'app-prestation-reject-view',
  standalone: true,
  imports: [
    DatePipe,
    MatButton,
  ...
  templateUrl: './prestation-reject-view.component.html',
  styleUrl: './prestation-reject-view.component.css'
})
export class PrestationRejectViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/prestation/requests/rejects/list");
    }
