...
@Component({
  selector: 'app-prestation-submit-view',
  standalone: true,
    imports: [
        DatePipe,
        MatButton,
  ...
  templateUrl: './prestation-submit-view.component.html',
  styleUrl: './prestation-submit-view.component.css'
})
export class PrestationSubmitViewComponent  implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/prestation/requests/submits/list");
    }
