...
@Component({
  selector: 'app-reinsurance-validate-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './reinsurance-validate-view.component.html',
  styleUrl: './reinsurance-validate-view.component.css'
})
export class ReinsuranceValidateViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/reinsurance/requests/validates/list")
    }
