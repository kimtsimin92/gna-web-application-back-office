...
@Component({
  selector: 'app-reinsurance-reject-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './reinsurance-reject-view.component.html',
  styleUrl: './reinsurance-reject-view.component.css'
})
export class ReinsuranceRejectViewComponent  implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/reinsurance/requests/rejects/list")
    }
