...
export class ReinsuranceSubmitListComponent implements OnInit, AfterViewInit, OnDestroy   {
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/reinsurance/requests/submits/view")
      .then(() => {
        this.loadingPage = false;
      });
