...
@Component({
  selector: 'app-reinsurance-submit-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './reinsurance-submit-view.component.html',
  styleUrl: './reinsurance-submit-view.component.css'
})
export class ReinsuranceSubmitViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/reinsurance/requests/submits/list")
    }
