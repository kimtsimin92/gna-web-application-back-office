...
@Component({
  selector: 'app-expertise-submit-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './expertise-submit-view.component.html',
  styleUrl: './expertise-submit-view.component.css'
})
export class ExpertiseSubmitViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/expertise/requests/submits/list")
    }
