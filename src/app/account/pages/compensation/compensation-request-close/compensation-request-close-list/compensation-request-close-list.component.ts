...
@Component({
  selector: 'app-compensation-request-close-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './compensation-request-close-list.component.html',
  styleUrl: './compensation-request-close-list.component.css'
})
export class CompensationRequestCloseListComponent implements OnInit, AfterViewInit, OnDestroy  {
  ...
  ngOnInit(): void {
    ...
    this.headerTitle = "Indeminisations";
