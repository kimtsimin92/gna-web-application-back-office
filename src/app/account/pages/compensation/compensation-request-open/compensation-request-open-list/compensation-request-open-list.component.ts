...
@Component({
  selector: 'app-compensation-request-open-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './compensation-request-open-list.component.html',
...
export class CompensationRequestOpenListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/compensations/requests/close/view")
      .then(() => {
        this.loadingPage = false;
      });
*/
