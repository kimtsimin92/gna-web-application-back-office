...
@Component({
  selector: 'app-user-coinsurer-add',
  standalone: true,
  imports: [
    DropdownModule,
    FormsModule,
  ...
  templateUrl: './user-coinsurer-add.component.html',
  styleUrl: './user-coinsurer-add.component.css'
})
export class UserCoinsurerAddComponent implements OnInit, OnDestroy {
