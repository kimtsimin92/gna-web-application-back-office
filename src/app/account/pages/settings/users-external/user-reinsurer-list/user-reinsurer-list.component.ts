...
@Component({
  selector: 'app-user-reinsurer-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './user-reinsurer-list.component.html',
  styleUrl: './user-reinsurer-list.component.css'
})
export class UserReinsurerListComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  onViewAdd() {
    this._router.navigateByUrl("/account/admin/users/external/reinsurers/add");
  }
  ...
  onView(userAccountData: any) {
    ...
    this._router.navigateByUrl("/account/admin/users/external/reinsurers/view")
      .then(() => {
        this.loadingPage = false;
      });
  ...
  onViewEdit(userAccountData: any) {
    ...
    this._router.navigateByUrl("/account/admin/users/external/reinsurers/edit")
      .then(() => {
        this.loadingPage = false;
      });
