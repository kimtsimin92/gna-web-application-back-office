...
@Component({
  selector: 'app-user-reinsurer-edit',
  standalone: true,
  imports: [
    DividerModule,
    FormsModule,
  ...
  templateUrl: './user-reinsurer-edit.component.html',
  styleUrl: './user-reinsurer-edit.component.css'
})
export class UserReinsurerEditComponent implements OnInit, OnDestroy {
