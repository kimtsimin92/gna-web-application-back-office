...
@Component({
  selector: 'app-user-coinsurer-view',
  standalone: true,
    imports: [
        DatePipe,
        MatButton,
  ...
  templateUrl: './user-coinsurer-view.component.html',
  styleUrl: './user-coinsurer-view.component.css'
})
export class UserCoinsurerViewComponent implements OnInit, OnDestroy {
