...
@Component({
  selector: 'app-accounting-request-reject-view',
  standalone: true,
  imports: [
    DatePipe,
    MatButton,
  ...
  templateUrl: './accounting-request-reject-view.component.html',
  styleUrl: './accounting-request-reject-view.component.css'
})
export class AccountingRequestRejectViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/accounting/requests/rejects/list");
    }
