...
@Component({
  selector: 'app-accounting-request-submit-view',
  standalone: true,
  imports: [
    DatePipe,
    MatButton,
  ...
  templateUrl: './accounting-request-submit-view.component.html',
  styleUrl: './accounting-request-submit-view.component.css'
})
export class AccountingRequestSubmitViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/accounting/requests/submits/list");
    }
