...
@Component({
  selector: 'app-sinister-request-submit-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './sinister-request-submit-view.component.html',
  styleUrl: './sinister-request-submit-view.component.css'
})
export class SinisterRequestSubmitViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/sinister/requests/submits/list")
    }
