...
@Component({
  selector: 'app-sinister-request-submit-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './sinister-request-submit-list.component.html',
  styleUrl: './sinister-request-submit-list.component.css'
})
export class SinisterRequestSubmitListComponent implements OnInit, AfterViewInit, OnDestroy  {
...
*/
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/sinister/requests/submits/view")
      .then(() => {
        this.loadingPage = false;
      });
