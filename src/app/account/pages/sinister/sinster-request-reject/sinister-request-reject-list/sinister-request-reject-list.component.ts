...
@Component({
  selector: 'app-sinister-request-reject-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './sinister-request-reject-list.component.html',
  styleUrl: './sinister-request-reject-list.component.css'
})
export class SinisterRequestRejectListComponent implements OnInit, AfterViewInit, OnDestroy  {
...
console.log("fjnfkvk",this.dataList);*/
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/sinister/requests/rejects/view")
      .then(() => {
        this.loadingPage = false;
      });
