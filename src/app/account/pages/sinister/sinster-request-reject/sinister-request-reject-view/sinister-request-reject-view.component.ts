...
@Component({
  selector: 'app-sinister-request-reject-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './sinister-request-reject-view.component.html',
  styleUrl: './sinister-request-reject-view.component.css'
})
export class SinisterRequestRejectViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/sinister/requests/rejects/list")
    }
