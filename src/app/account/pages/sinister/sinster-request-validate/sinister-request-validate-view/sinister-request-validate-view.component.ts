...
@Component({
  selector: 'app-sinister-request-validate-view',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './sinister-request-validate-view.component.html',
  styleUrl: './sinister-request-validate-view.component.css'
})
export class SinisterRequestValidateViewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("CUSTOMER_ACCOUNT_REQUEST_DATA")) {
      ...
      this._router.navigateByUrl("/account/sinister/requests/validates/list")
    }
