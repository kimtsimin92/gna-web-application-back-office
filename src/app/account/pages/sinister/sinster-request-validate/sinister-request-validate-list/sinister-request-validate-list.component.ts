...
@Component({
  selector: 'app-sinister-request-validate-list',
  standalone: true,
  imports: [
    ButtonModule,
    DatePipe,
  ...
  templateUrl: './sinister-request-validate-list.component.html',
  styleUrl: './sinister-request-validate-list.component.css'
})
export class SinisterRequestValidateListComponent implements OnInit, AfterViewInit, OnDestroy  {
...
*/
  ...
  onGoToView(data: any) {
    ...
    this._router.navigateByUrl("/account/sinister/requests/validates/view")
      .then(() => {
        this.loadingPage = false;
      });
