...
@Component({
  selector: 'app-subscription-validate-list',
  standalone: true,
  imports: [
    ButtonModule,
    CurrencyPipe,
  ...
  templateUrl: './subscription-validate-list.component.html',
  styleUrl: './subscription-validate-list.component.css'
})
export class SubscriptionValidateListComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  onView(item: any) {
    ...
    this._router.navigateByUrl("account/subscriptions/validates/view")
      .then(() => {
  ...
  onGetDataList() {
    ...
    this.accountService.getSubscriptionValidatedList(this.pageSort, this.pageOrder, this.pageNumber, this.pageSize)
