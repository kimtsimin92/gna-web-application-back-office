...
@Component({
  selector: 'app-subscription-reject-list',
  standalone: true,
  imports: [
    ButtonModule,
    CurrencyPipe,
  ...
  templateUrl: './subscription-reject-list.component.html',
  styleUrl: './subscription-reject-list.component.css'
})
export class SubscriptionRejectListComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  onView(item: any) {
    ...
    this._router.navigateByUrl("account/subscriptions/rejects/view")
      .then(() => {
  ...
  onGetDataList() {
    ...
    this.accountService.getSubscriptionRejectedList(this.pageSort, this.pageOrder, this.pageNumber, this.pageSize)
