...
@Component({
  selector: 'app-subscription-submit-list',
  standalone: true,
  imports: [
    ButtonModule,
    CurrencyPipe,
  ...
  templateUrl: './subscription-submit-list.component.html',
  styleUrl: './subscription-submit-list.component.css'
})
export class SubscriptionSubmitListComponent implements OnInit, OnDestroy, AfterViewInit {
